# In the last question Alan showed Alyssa 
# this code which keeps track of items for a shopping cart application:
...
# By defining an attr_writer for `@quantity` we make the method public which means
# that it could be directly modified from outside the class which might not be
# desirable.